  ...
  return (
    <View>
      <View style={styles.row}>
        ...
        <AppText style={styles.textPrice}>${itemsPrice?.toFixed(2)}</AppText>
      </View>
      <View style={styles.row}>
        <AppText style={styles.textTitle}>Taxes:</AppText>
        <AppText style={styles.textPrice}>${Taxes.toFixed(2)}</AppText>
      </View>
      <View style={styles.row}>
        <AppText style={styles.textTitle}>Shipping: </AppText>
        <AppText style={styles.textPrice}>${Shipping.toFixed(2)}</AppText>
      </View>
      <View style={styles.seprator} />
      <View style={styles.row}>
        <AppText style={styles.textTitle}>Order Total:</AppText>
        <AppText style={styles.textPrice}>${orderTotal?.toFixed(2)}</AppText>
      </View>
    </View>
  )
}
